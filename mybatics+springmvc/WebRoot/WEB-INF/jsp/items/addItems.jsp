...
<body> 
<!-- 校验错误信息显示处 -->
<c:if test="${allErrors!=null}"><!-- 要先判断是否为null 否则会报错 -->
	<c:forEach items="${allErrors}" var="allerror">
		${allerror.defaultMessage }</br> <!-- 提取类中的属性defaultMessage -->
	</c:forEach>
</c:if>
<!-- ${pageContext.request.contextPath }是项目的绝对路径 -->
